...
<body>
    <?php
        include'connect.php';
    ?>
    <img class="bg" src="img/bankbg.jpeg" alt="BackGround" width="100%">
        <nav>
    ...
    <div class="covidnorm">
        <p>!!! TO STOP SPREAD OF DEADLY COVID-19, ALWAYS WEAR MASK/FACE COVER IN PUBLIC PLACES & ENCOURAGE OTHERS TO FOLLOW THE NORMS !!!</p>
    </div>
    <div class="textarea">
    ...
    <ul>
        ...
        <li style="margin-left: 50px;"><img src="img/history_2.png" alt="History"></li>
    </ul>
    </div>
    <br><br>
    <div class="buttons">
